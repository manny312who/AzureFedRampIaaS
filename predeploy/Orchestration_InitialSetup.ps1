...
function orchestration {
    ...
    Select-AzSubscription -SubscriptionId $SubscriptionId | Out-String | Write-Verbose
        ...
        # Uncomment and Pass in AAD APP ID if one is already made below
        ##$aadAppName = "Blueprintca7b58af-3dec-44c3-831c-15062a2f9cd9" ;
        ...
        if(-not $SvcPrincipals) {
			...
			# Wait while the AAD Applicaiton is being finalized
